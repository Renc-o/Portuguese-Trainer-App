...
export default function App() {
  ...
  const [direction, setDirection] = useState<"pt-fr" | "fr-pt">("pt-fr");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <SegmentedControl
            values={["PT → FR", "FR → PT"]}
            selectedIndex={direction === "pt-fr" ? 0 : 1}
            tintColor={direction === "pt-fr" ? "#cc5757" : "#1976D2"}
            ...
            onChange={(event) => {
                ...
                setDirection(index === 0 ? "pt-fr" : "fr-pt");
